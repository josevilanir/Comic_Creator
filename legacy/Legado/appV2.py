#Ordenação de paginas testada e corrigida
import os
import re
...
@appV2.route("/baixar_imagens", methods=["POST"])
def baixar_imagens():
...
@appV2.route("/gerar_cbr", methods=["POST"])
def gerar_pdf():
